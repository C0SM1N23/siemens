    ...
    initial begin
        ...
        fork
            ...
            begin
                ...
                // BW_CAP is structured as: {MAX_TOKENS[15:0], REFILL_RATE[15:0]}
                // CH0 gets Refill=1, Max=16 (Very slow) -> BW_CAP = 32'h0010_0001
                // CH1 gets Refill=16, Max=32 (Very fast) -> BW_CAP = 32'h0020_0010
                ...
                // Deliberately wait for CH1 to finish FIRST, even though started second
