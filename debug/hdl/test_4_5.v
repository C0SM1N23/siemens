    ...
    initial begin
        ...
        fork
            ...
            begin
                ...
                // ==========================================================
                // T04 & T05: Concurrent Channels Arbitration (Round-Robin)
                // ==========================================================
                $display("\n--- [T04/T05] RUNNING: 4-Channel Concurrent Arbitraj ---");
                
                // Repozitionam pachete proaspete
                ...
                if (ram_memory[(32'h00002000 >> 2)] === 32'hAAAA0000 &&
                    ...
                    $display(">>> [T04/T05] PASSED! (No data lost during heavy traffic)");
                end else begin
                    $display(">>> [T04/T05] FAILED! (Data corruption detected)");
                end
                #100;
                $finish;
            end
