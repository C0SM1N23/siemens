    ...
    initial begin
        ...
        fork
            ...
            begin
                ...
                axi_lite_write(ADDR_INT_ENABLE, 32'h0000000F, 0); // Enable all
                ...
                #50;
                // Read the register to confirm interrupt latching
                ...
                if (read_val[0] === 1'b1 && irq[0] === 1'b1) begin
                    ...
                    axi_lite_write(ADDR_INT_STATUS, 32'h00000001, 0); // Clear bit 0 (W1C)
                    #50;
