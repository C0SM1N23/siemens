    ...
    initial begin
        ...
        fork
            ...
            begin
                ...
                // ==========================================================
                // T08: Unaligned Transfer Test (Corner Case)
                // ==========================================================
                $display("\n--- [T08] RUNNING: Unaligned Transfer (40 Bytes) ---");
                setup_dma_transfer(32'h0400, 32'h6800, 32'h7000, 32'h28, 32'hD4D4D4D4); // 0x28 = 40 bytes
                start_channel(ADDR_CH2_DESC_ADDR, 32'h0400, 32'h00200008); 
                wait_channel_done(ADDR_CH2_STATUS);
                
                // Verificam ca byte-ul 40 a ramas NEATINS (0x00000000)
                if (ram_memory[(32'h00007000 + 40) >> 2] === 32'h00000000) 
                    $display(">>> [T08] PASSED (Memory boundaries respected for 40B transfer)");
                else 
                    $display(">>> [T08] FAILED (Memory overwritten past 40B boundary!)");
