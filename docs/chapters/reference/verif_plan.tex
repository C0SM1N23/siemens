...
\paragraph{Result.} Pass against the delivered RTL.

\begin{rtlnote}
\textbf{The bench was validated by mutation.} A bench that has never failed
proves nothing about its own sensitivity, so its teeth are demonstrated
directly. Removing the saturation term from the RAS
