...
The latch has no reset --- it is read only while a transaction is active and each
new transaction overwrites it first. This is the source of the idle-bus
\texttt{X} values noted in Chapter~\ref{ch:pipectl}.
