...
\file{control.v} & Turns the opcode into the S2 control lines. Any unrecognised encoding sets
                   \sig{illegal} and forces every other control line inactive, so an illegal
                   instruction has no side effects at all --- it only traps. \\
