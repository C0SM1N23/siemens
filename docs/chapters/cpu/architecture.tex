...
\begin{tikzpicture}[x=1mm,y=1mm,font=\small]
  ...
  % --- pipeline registers ------------------------------------------------
  \node[draw=rulegrey,fill=boxbg,minimum width=7,minimum height=68,inner sep=0] (ifdx) at (24,-28) {};
  \node[rotate=90,font=\tiny] at (24,-28) {IF/DX};
  \node[draw=rulegrey,fill=boxbg,minimum width=7,minimum height=68,inner sep=0] (dxwb) at (130,-28) {};
  \node[rotate=90,font=\tiny] at (130,-28) {DX/WB};
