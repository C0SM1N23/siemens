...
// Write has priority over read: a fully assembled write is taken first, and a read
// is refused while a write is half-assembled (aw_have or w_have still set)
//
// =============================================================================

module dp_sram_axi4lite_slave_fsm #(
