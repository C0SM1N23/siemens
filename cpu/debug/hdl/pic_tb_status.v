...
module pic_tb_status;
    ...
    initial begin
        ...
        if ($test$plusargs("verbose")) $display("   step 2: claim the interrupt (cpu_irq_ack)");
        claim_offer;
        if ($test$plusargs("verbose"))
        ...
        if ($test$plusargs("verbose")) $display("   step 5: end of interrupt -> ACTIVE drops");
        end_of_interrupt;
    ...
    initial begin
        #500000;
        $fatal(1, "FAIL: tb_pic_status timeout");
    end
