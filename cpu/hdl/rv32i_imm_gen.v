...
module rv32i_imm_gen (
    ...
    always @(*) begin
        case (instr_i[6:0])
            // I-type
            `OPC_LOAD, `OPC_OP_IMM, `OPC_JALR: imm_out_o = {{20{instr_i[31]}}, instr_i[31:20]};

            // S-type (stores)
            `OPC_STORE: imm_out_o = {{20{instr_i[31]}}, instr_i[31:25], instr_i[11:7]};
            ...
            // U-type (LUI / AUIPC)
            `OPC_LUI, `OPC_AUIPC: imm_out_o = {instr_i[31:12], 12'b0};
