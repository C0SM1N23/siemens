...
Verification Specification — PIC & Companion specification, revision 2.1, 21 September 2026. \\ \addlinespace[3pt]
...
{\small
\begin{longtable}{@{}L{0.4800\dimexpr\linewidth-12pt\relax}L{0.5200\dimexpr\linewidth-12pt\relax}@{}}
\toprule
...
\textbf{Source} & \textbf{Role} \\ \midrule
\endhead
Programmable Interrupt Controller with Advanced Scheduling & Original internship brief in cpu/docs/brief/. \\ \addlinespace[3pt]
cpu/hdl/pic.v and axi\_lite\_slave.v & Implemented interface and register-access behaviour. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
{\small
...
Reset / target & Active-low asynchronous reset; behavioural RTL simulation. & posedge clk\_i; reset disables all sources; no synthesis result claimed. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsection{Configuration and integration limits}
\noindent The module has no Verilog parameters; every configurable quantity is either fixed in the RTL or programmed through a register. The tables separate the two, then state what an integrator has to guarantee outside the block.\par\medskip
{\small
...
AXI width & 32-bit address/data; four strobes; three protection bits; two response bits. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
{\small
\begin{longtable}{@{}L{0.2600\dimexpr\linewidth-12pt\relax}L{0.7400\dimexpr\linewidth-12pt\relax}@{}}
\toprule
...
Depth limit & A lower NEST\_MAX does not discard existing active contexts; it suppresses new offers until sufficient EOIs occur. \\ \addlinespace[3pt]
...
Implementation target & Behavioural RTL simulation. No synthesis / frequency claim. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
Resolution pipeline & The PIC brief describes staged resolution. This RTL resolves eligibility and the priority key combinationally and registers the offer; there are no successive registered arbitration stages. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
\begin{figure}[H]\centering\includegraphics[width=\linewidth,height=132mm,keepaspectratio]{figures/pic_essential.pdf}\caption{Architectural view: HW/SW requests share 16 source slots; the stack records active service contexts.}\end{figure}
...
Offer & cpu\_irq\_o and cpu\_irq\_vec\_o are registered together; pending\_o is a separate combinational mask. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
Depth enforcement & Only an inactive, enabled, CPU-unmasked source above the saved top key is eligible. depth < NEST\_MAX is additionally required for an offer; an eligible blocked source sets OVF. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
Software injection & Write 0xA5A50001 to SRCx\_SW\_TRIG with WSTRB[3:2]=11 and WSTRB[0]=1. Clear explicitly with bit 0=0, or automatically by claim. A software-only request follows the same deadline policy as hardware. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
\begin{figure}[H]\centering\includegraphics[width=\linewidth]{waves/pic_claim.pdf}\caption{Source 3 service: the request is claimed once; EOI returns nesting depth to zero.}\end{figure}
{\small
...
Source remains high after EOI & It can become eligible again; PIC does not clear the external peripheral. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
\begin{figure}[H]\centering\includegraphics[width=\linewidth]{waves/pic_nesting.pdf}\caption{Source 8 enters service, source 9 preempts, and two EOIs restore then remove the outer context.}\end{figure}
{\small
\begin{longtable}{@{}L{0.2800\dimexpr\linewidth-12pt\relax}L{0.7200\dimexpr\linewidth-12pt\relax}@{}}
\toprule
...
Reband active source & Saved priority threshold is unchanged until that context is popped. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
\begin{figure}[H]\centering\includegraphics[width=\linewidth]{waves/pic_edge_claim.pdf}\caption{Simultaneous claim and a new source edge: the new edge remains latched for service after EOI.}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=\linewidth]{waves/pic_spurious.pdf}\caption{Source withdrawal before claim: the active context is marked spurious and the event is logged.}\end{figure}
{\small
...
Spurious claim & The previously offered source is no longer pending when claimed; log globally and per source; unwind with normal EOI. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
\begin{figure}[H]\centering\includegraphics[width=\linewidth]{waves/pic_escalation.pdf}\caption{Reordered bands, source 2 deadline = 10 cycles: escalation precedes the registered offer changing from source 1 to 2.}\end{figure}
{\small
...
MODE=1 & Move to the next strictly greater urgency from BAND\_CONFIG, not simply band number minus one. \\ \addlinespace[3pt]
...
Status & SRCx\_STATUS.ESC is wait-local; INT\_STATUS.ESC is sticky until RW1C. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\section{Interfaces}
\subsection{Hardware interface}
\noindent All ports share one clock domain and one asynchronous reset. The table gives the direction, width and meaning of every port: the 16 source inputs, the CPU handshake that carries the offer back and the claim and EOI forward, and the AXI4-Lite register window.\par\medskip
{\small
...
\begin{figure}[H]\centering\includegraphics[width=\linewidth]{waves/pic_reset.pdf}\caption{Reset from a configured state: rst\_n asserts at posedge +2 ns; depth and enables clear before the next edge.}\end{figure}
{\small
\begin{longtable}{@{}L{0.2600\dimexpr\linewidth-12pt\relax}L{0.7400\dimexpr\linewidth-12pt\relax}@{}}
\toprule
...
Reset during transfer & Captured AW/W and pending B/R responses are cleared; no pre-reset response is replayed afterwards. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
0xDC & INT\_STATUS & RW1C & 0x00000000 & Global event flags. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
{\small
\begin{longtable}{@{}L{0.2600\dimexpr\linewidth-12pt\relax}L{0.7400\dimexpr\linewidth-12pt\relax}@{}}
\toprule
...
Access classes & RW: read/write; RO: read-only; RW1C: write-one-to-clear; WARL: value coerced to a legal setting; RAZ/WI: read zero / write ignored. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: SRCx\_CONFIG}
\subsection*{SRCx\_CONFIG — 0x00 + 4x}
{\small
...
[0] & TRIG & RW & 0 & 0: level. 1: latch rising edges until claim. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: SRCx\_SW\_TRIG}
\subsection*{SRCx\_SW\_TRIG — 0x40 + 4x}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
[0] & SWREQ & RW + HW clear & 0 & Set with key; zero clears without key. WSTRB[0] required. Claim clears; a simultaneous new set is retained. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: SRCx\_STATUS}
\subsection*{SRCx\_STATUS — 0x80 + 4x}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
[0] & PEND & RO & 0 & Enabled HW/SW request, including a held level during its handler. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: BAND\_CONFIG}
\subsection*{BAND\_CONFIG — 0xC0}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
[1:0] & BAND0\_URG & RW & 3 & Urgency of band 0. Higher urgency wins. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: NEST\_STATUS}
\subsection*{NEST\_STATUS — 0xC4}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
[4:0] & DEPTH & RO & 0 & Active nesting levels, 0–16. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: NEST\_MAX}
\subsection*{NEST\_MAX — 0xC8}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
[4:0] & LIMIT & RW / WARL & 8 & Clamp 0 to 1 and values above 16 to 16. Requires WSTRB[0]. Lowering the limit does not unwind active handlers. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: ACTIVE\_VEC}
\subsection*{ACTIVE\_VEC — 0xCC}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
[3:0] & ID & RO & 0 & Top active source; meaningful when VALID=1. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: SPURIOUS\_LOG}
\subsection*{SPURIOUS\_LOG — 0xD0}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
[15:0] & FLAGS & RW1C & 0 & One sticky bit per spurious source. WSTRB[1:0] qualify clear. New hardware set wins over clear. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: ESCALATION\_CFG}
\subsection*{ESCALATION\_CFG — 0xD4}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
[1:0] & TARGET & RW & 0 & Destination band for jump mode. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: INT\_ENABLE}
\subsection*{INT\_ENABLE — 0xD8}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
\endhead
[31:16] & Reserved & RAZ/WI & 0 & Reads zero; writes ignored. \\ \addlinespace[3pt]
[15:0] & ENABLE & RW & 0 & One source enable per bit; byte strobes apply. CPU mask is a separate filter. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}

\clearpage
\subsubsection{Register fields: INT\_STATUS}
\subsection*{INT\_STATUS — 0xDC}
{\small
\begin{longtable}{@{}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1800\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.1200\dimexpr\linewidth-48pt\relax}L{0.4600\dimexpr\linewidth-48pt\relax}@{}}
\toprule
\textbf{Bits} & \textbf{Field} & \textbf{Access type} & \textbf{Reset} & \textbf{Description} \\ \midrule
...
[0] & SPUR & RW1C & 0 & At least one spurious claim occurred. New hardware event wins over a same-cycle clear. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
8 & INT\_STATUS / SPURIOUS\_LOG & Read events and write ones to the flags that should be cleared. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
{\small
...
Nested contexts & NEST\_STATUS.DEPTH and TOP\_ID; software cannot read the whole stack. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
Verify & Run the PIC benches in regress.do and the bound-assertion flow run\_verilator.sh; check the final address map. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
...
\texttt{rd\_ok\_i} & input & 1 & Offset is readable; low selects SLVERR. \\ \addlinespace[3pt]
\bottomrule\end{longtable}}
