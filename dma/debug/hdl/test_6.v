    ...
    initial begin
        ...
        fork
            ...
            begin
                ...
                // ==========================================================
                // T06: Bandwidth Throttling (Token Bucket) Test
                // ==========================================================
                $display("\n--- [T06] RUNNING: Bandwidth Throttling (CH0 Slow vs CH1 Fast) ---");
                
                // Pregatim date in memorie
                ...
                // BW_CAP este structurat asa: {MAX_TOKENS[15:0], REFILL_RATE[15:0]}
                // CH0 va primi Refill=1, Max=16 (Foarte incet) -> BW_CAP = 32'h0010_0001
                // CH1 va primi Refill=16, Max=32 (Foarte rapid) -> BW_CAP = 32'h0020_0010
                ...
                // Asteptam in mod deliberat ca CH1 sa termine PRIMUL, desi a pornit al doilea
                wait_channel_done(ADDR_CH1_STATUS);
                $display("          CH1 (Fast) finished. Waiting for CH0 (Slow) to finish...");
                
                wait_channel_done(ADDR_CH0_STATUS);
                $display(">>> [T06] PASSED! CH0 finished significantly later. Throttling is working.");
